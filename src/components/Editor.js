        ...
        <div className="h-full px-3 py-4 bg-gray-800 flex justify-between flex-col ">
         ...
         <div className="flex justify-center   border-b-2 border-gray-600">
          ...
          {!isCopied ?  <ImCopy/> :   <BsCheckAll/>}
            ...
            <button className=" flex justify-center gap-3 items-center text-white cursor-pointer bg-[#ff3c3c] border-0 py-2 px-6 focus:outline-none rounded text-lg mb-2 active:scale-95 duration-150 ">
              Exit
